...
The result is a constructive high-order area-refinement principle for regular
...
The perturbation result is not a failure of the framework.  It is the
regularity boundary of the framework.  The raw second-order law is robust
across all tested perturbations.  The two-scale operator remains broadly
effective.  The three-scale operator is useful but variable.  The four-scale
operator is the most sensitive to perturbation and loses the clean
eighth-order behavior seen on regular grids.
...
a constructive high-order area-refinement method for regular spherical
...
\[
  \texttt{spherical\_irregular\_polygon\_stress\_test.py}.
\]
